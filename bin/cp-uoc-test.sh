...
cd ../Gitlab_UOC/PLATACON_WEB_RI_TEST/
git pull
cp -r * ../../PLATACON_WEB_RI_TEST_TMP/
# copy new content to folder
cd ../../UOC_WebRI
cp -r * ../Gitlab_UOC/PLATACON_WEB_RI_TEST/ 
...
cp ../../PLATACON_WEB_RI_TEST_TMP/themes/uoc/static/admin/config.yml ./themes/uoc/static/admin/config.yml
# copy content principal and cercador folders
cd ../../UOC_WebRI
cp -r ./content/principal ../Gitlab_UOC/PLATACON_WEB_RI_TEST/content
cp -r ./content/cercador ../Gitlab_UOC/PLATACON_WEB_RI_TEST/content
cp -r ./content/mapa-ambits-recerca ../Gitlab_UOC/PLATACON_WEB_RI_TEST/content
cp -r ./content/difusions ../Gitlab_UOC/PLATACON_WEB_RI_TEST/content
cp -r ./content/contacte ../Gitlab_UOC/PLATACON_WEB_RI_TEST/content
