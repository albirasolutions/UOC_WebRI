...
cd ../../UOC_WebRI
cp -r * ../Gitlab_UOC/PLATACON_WEB_RI_PRE/ 
...
cp ../../PLATACON_WEB_RI_PRE_TMP/themes/uoc/static/admin/config.yml ./themes/uoc/static/admin/config.yml
# copy content principal and cercador folders
cd ../../UOC_WebRI
cp -r ./content/principal ../Gitlab_UOC/PLATACON_WEB_RI_PRE/content
